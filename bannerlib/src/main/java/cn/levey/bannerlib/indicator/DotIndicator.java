...
public class DotIndicator extends LinearLayout {
    ...
    private static final float STATE_SMALLEST = 1f;
    private static final float STATE_SMALL = 1f;
    private static final float STATE_NORMAL = 1f;
    ...
    private void updateSimpleState(int position) {
        ...
        animateViewScale(getChildAt(position), STATE_SELECTED, true);
    ...
    private void updateOverflowState(int position) {
        ...
        int start = position - MAX_INDICATORS + (MAX_INDICATORS/2);
        ...
        } else if (position == (MAX_INDICATORS/2)) {
    ...
    private void animateViewScale(@Nullable View view, float scale, boolean isSelected) {
        ...
        if(isSelected){
            ...
            view.setBackgroundResource(R.drawable.banner_indicator_unselected);
        }
