...
github &nbsp;&nbsp;&nbsp;&nbsp; [rxbanner_demo.apk](https://github.com/leveychen/RxBanner/releases/download/1.0.5/rxbanner_v1.0.5_demo.apk)
...
```xml
    implementation 'com.github.leveychen:RxBanner:1.0.5'
```
